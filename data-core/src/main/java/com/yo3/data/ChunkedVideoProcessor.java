...
public class ChunkedVideoProcessor {
    ...
    public ChunkedVideoProcessor() {
        this.storageBasePath = System.getenv().getOrDefault("yo3_STORAGE_PATH", "./storage/processed");
    ...
    private SecretKey generateOrLoadMasterKey() {
        String keyBase64 = System.getenv("yo3_MASTER_KEY");
        ...
        if (keyBase64 != null && !keyBase64.isEmpty()) {
            ...
            try {
                ...
                logger.info("Generated key (set yo3_MASTER_KEY): {}", keyForEnv);
